...
class COVID19DAOPatientVitalSign : DAOPatientVitalSign {
    ...
    static func getVitalSign(patient: Patient, option: String) {
        ...
        if option == "all" {
            for i in 0...10 {
                patient.addVitalSign(type: ecg, value: Double(Int.random(in: 50...120)))
                patient.addVitalSign(type: spo2, value: Double(Int.random(in: 90...100)))
                patient.addVitalSign(type: fr, value: Double(Int.random(in: 12...20)))
                patient.addVitalSign(type: pas, value: Double(Int.random(in: 90...145)))
                patient.addVitalSign(type: pad, value: Double(Int.random(in: 60...85)))
                patient.addVitalSign(type: temp, value: Double(Float.random(in: 36...40)))
